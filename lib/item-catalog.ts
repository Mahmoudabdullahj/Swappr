...
export const CATALOG: CategoryConfig[] = [
  ...
  },
  {
    ...
    brands: [
      ...
      { name: 'Video Games', models: ['PS5', 'PS4', 'Xbox Series X/S', 'Xbox One', 'Nintendo Switch', 'Nintendo 3DS', 'PC'] },
    ...
    specs: [
      ...
      { key: 'storage', label: 'Storage', type: 'select', options: ['N/A', '250GB', '500GB', '1TB', '2TB'], brands: ['Sony (PlayStation)', 'Microsoft (Xbox)', 'Nintendo', 'Branded Gaming PCs', 'Custom PC'] },
      { key: 'color', label: 'Color', type: 'select', options: ['Black', 'White', 'Red', 'Blue', 'Purple', 'Gold', 'Other'], brands: ['Sony (PlayStation)', 'Microsoft (Xbox)', 'Nintendo', 'Controllers', 'Gaming Accessories', 'Branded Gaming PCs', 'Custom PC'] },
  ...
  },
  {
    ...
    brands: [
      { name: 'Canon', models: [
        'EOS R1', 'EOS R5 Mark II', 'EOS R5C', 'EOS R5', 'EOS R6 Mark II', 'EOS R7', 'EOS R8', 'EOS R10', 'EOS R50', 'EOS R100',
        'PowerShot V10', 'PowerShot G7X Mark III', 'PowerShot G5X Mark II',
        'EOS 90D', 'EOS Rebel SL3 / 250D', 'EOS Rebel T8i / 850D',
      ] },
      { name: 'Nikon', models: [
        'Z9', 'Z8', 'Z7 III', 'Z7 II', 'Z6 III', 'Z6 II', 'Z5 II', 'Zf', 'Zfc', 'Z50 II', 'Z50', 'Z30',
      ...
      { name: 'Fujifilm', models: [
        'X-H2S', 'X-H2', 'X-T5', 'X-T4', 'X-T3', 'X-T30 II', 'X-T30',
        'X-S20', 'X-S10', 'X-M5',
        'X100VI', 'X100V', 'X-E4',
        'GFX 100 II', 'GFX 100S II', 'GFX 50S II',
      ] },
      { name: 'Panasonic', models: [
        'Lumix S9', 'Lumix S5 II', 'Lumix S5 IIX', 'Lumix S5',
        'Lumix G9 II', 'Lumix GH7', 'Lumix GH6', 'Lumix GH5 II', 'Lumix GH5',
      ] },
      { name: 'OM System / Olympus', models: [
        'OM-1 Mark II', 'OM-1', 'OM-5',
        'OM-D E-M10 Mark IV', 'OM-D E-M5 Mark III', 'PEN E-P7',
      ] },
      { name: 'GoPro', models: [
        'GoPro Hero 13 Black', 'GoPro Hero 12 Black', 'GoPro Hero 11 Black', 'GoPro Hero 10 Black', 'GoPro Hero 9 Black',
        'GoPro Max', 'GoPro Hero (2024)',
      ] },
      { name: 'DJI', models: [
        'Osmo Action 5 Pro', 'Osmo Action 4', 'Osmo Action 3',
        'DJI Pocket 3', 'DJI Pocket 2',
        'DJI Mini 4 Pro', 'DJI Mini 4K', 'DJI Mini 3 Pro', 'DJI Mini 3',
        'DJI Air 3S', 'DJI Air 3', 'DJI Air 2S',
        'DJI Mavic 3 Pro', 'DJI Mavic 3 Classic',
      ] },
      { name: 'Leica', models: [
        'Leica Q3 43', 'Leica Q3', 'Leica Q2', 'Leica Q2 Monochrom',
        'Leica M11-P', 'Leica M11 Monochrom', 'Leica M11', 'Leica M10-R',
        'Leica SL3', 'Leica SL2', 'Leica D-Lux 8', 'Leica D-Lux 7',
      ] },
      { name: 'Ricoh', models: [
        'GR IIIx', 'GR III', 'Theta Z1', 'Theta SC2',
      ] },
      { name: 'Sigma', models: [
        'fp L', 'fp', 'BF',
      ] },
      { name: 'Film Camera', models: [
        'Canon AE-1 Program', 'Canon AE-1', 'Canon A-1', 'Canon EOS 3', 'Canon F-1',
        'Nikon FM2', 'Nikon F3', 'Nikon FE2', 'Nikon FA', 'Nikon N80 / F80',
        'Olympus OM-1 (film)', 'Olympus OM-10', 'Olympus Stylus Epic / mju II',
        'Pentax K1000', 'Pentax ME Super', 'Pentax 67',
        'Minolta X-700', 'Minolta X-570', 'Minolta Maxxum 7',
        'Contax T2', 'Contax T3', 'Contax G2',
        'Leica M6', 'Leica M7', 'Leica M-A',
        'Hasselblad 500CM', 'Hasselblad 503CW',
        'Mamiya RB67', 'Mamiya 7 II',
        'Yashica T4', 'Rollei 35',
        'Polaroid SX-70', 'Polaroid Now+',
        'Instax Mini 40', 'Instax Mini 12', 'Instax Wide 400',
        'Other Film Camera',
      ] },
    ],
    specs: [
