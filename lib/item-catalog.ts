...
export const CATALOG: CategoryConfig[] = [
  ...
  },
  {
    ...
    brands: [
      ...
      { name: 'Game CDs & Cartridges', models: ['PS5 Game CD', 'PS4 Game CD', 'Xbox Series Game', 'Xbox One Game', 'Nintendo Switch Cartridge', 'Nintendo 3DS Cartridge', 'PC Game DVD', 'Other Game Disc'] },
